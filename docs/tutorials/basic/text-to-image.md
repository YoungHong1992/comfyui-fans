...
> 在 ComfyUI 中构建文生图工作流：加载默认工作流、安装 SD1.5 检查点、编写提示词，并了解每个节点的作用。
...
![ComfyUI-文生图工作流](/img/external/raw-githubusercontent-com/basic/text-to-image-workflow.png)
...
<img src="/img/tutorial/gettingstarted/first-image-generation-7-queue.jpg" alt="图片生成" width="2640" height="1384" data-path="images/tutorial/gettingstarted/first-image-generation-7-queue.jpg" />
...
<img src="/img/comfy_core/conditioning/clip_text_encode.jpg" alt="CLIP Text Encoder" width="778" height="477" data-path="images/comfy_core/conditioning/clip_text_encode.jpg" />
...
<h2 id="text-to-image-working-principles">
  文生图是如何工作的？
</h2>
...
<img src="/img/tutorial/basic/text-image-workflow.jpg" alt="ComfyUI 文生图工作流讲解" width="2640" height="1384" data-path="images/tutorial/basic/text-image-workflow.jpg" />

### A. 加载模型（Load Checkpoint）节点

<img src="/img/comfy_core/loaders/load_checkpoint.jpg" alt="加载模型" width="807" height="384" data-path="images/comfy_core/loaders/load_checkpoint.jpg" />
...
<img src="/img/comfy_core/latent/empty_latent_image.jpg" alt="空Latent图像" width="855" height="420" data-path="images/comfy_core/latent/empty_latent_image.jpg" />
...
<img src="/img/comfy_core/conditioning/clip_text_encode.jpg" alt="CLIP文本编码器" width="778" height="477" data-path="images/comfy_core/conditioning/clip_text_encode.jpg" />
...
<img src="/img/comfy_core/sampling/k_sampler.png" alt="K 采样器" width="974" height="1076" data-path="images/comfy_core/sampling/k_sampler.png" />
...
<img src="/img/comfy_core/latent/vae_decode.jpg" alt="VAE 解码" width="854" height="370" data-path="images/comfy_core/latent/vae_decode.jpg" />

将 **K 采样器(KSampler)** 输出的潜在空间图像转换为像素空间图像

### F. 保存图像（Save Image）节点

<img src="/img/comfy_core/image/save_image.jpg" alt="保存图像" width="854" height="410" data-path="images/comfy_core/image/save_image.jpg" />
