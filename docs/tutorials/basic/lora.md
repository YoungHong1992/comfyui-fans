...
> 在 ComfyUI 中使用 LoRA 模型：安装 LoRA、用 Load LoRA 节点加载，并在检查点之上运行应用其风格的工作流。
...
<img src="/img/tutorial/basic/lora/compare.png" alt="LoRA 模型与基础模型对比" width="1356" height="678" data-path="images/tutorial/basic/lora/compare.png" />
...
在本示例中，我们将完成以下内容来学习[ComfyUI](https://github.com/Comfy-Org/ComfyUI) 中加载并使用 LoRA 模型，将涉及以下内容：
...
![ComfyUI 工作流 - LoRA](/img/external/raw-githubusercontent-com/main/lora.png)
...
<img src="/img/tutorial/basic/lora/flow_diagram.png" alt="ComfyUI 工作流 - LoRA 流程图" width="2000" height="888" data-path="images/tutorial/basic/lora/flow_diagram.png" />
...
<img src="/img/comfy_core/loaders/load_lora.jpg" alt="Load LoRA 节点" width="807" height="443" data-path="images/comfy_core/loaders/load_lora.jpg" />
