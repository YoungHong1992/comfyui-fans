...
<img src="/img/tutorial/basic/multiple_loras/compare.png" alt="ComfyUI 中 LoRA 模型单独使用效果" width="1356" height="678" data-path="images/tutorial/basic/multiple_loras/compare.png" />

但通过多个 LoRA 模型链式连接后，我们可以在最终的效果中看到两种风格融合在一起的效果

<img src="/img/tutorial/basic/multiple_loras/multiple_loras.png" alt="ComfyUI 中多 LoRA 模型应用示例结果" width="1024" height="1024" data-path="images/tutorial/basic/multiple_loras/multiple_loras.png" />
...
![ComfyUI 工作流 - 多 LoRA 模型应用示例](/img/external/raw-githubusercontent-com/main/multiple_loras.png)
...
<img src="/img/tutorial/basic/multiple_loras/flow_diagram.png" alt="ComfyUI 工作流 - 多 LoRA 模型应用示例流程图" width="2000" height="632" data-path="images/tutorial/basic/multiple_loras/flow_diagram.png" />
