...
![Depth 图像](/img/external/raw-githubusercontent-com/controlnet/depth_input.png)
...
![Depth 工作流](/img/external/raw-githubusercontent-com/controlnet/depth_controlnet.png)
...
<Note>
  如果你的网络无法顺利完成对应模型的自动下载，请尝试手动下载下面的模型，并放置到指定目录中：
</Note>
...
* [control\_v11f1p\_sd15\_depth\_fp16.safetensors](https://huggingface.co/comfyanonymous/ControlNet-v1-1_fp16_safetensors/blob/main/control_v11f1p_sd15_depth_fp16.safetensors?download=true)
...
<img src="/img/tutorial/controlnet/flow_diagram_depth.jpg" alt="ComfyUI 工作流 - Depth ControlNet 流程图" width="2000" height="1080" data-path="images/tutorial/controlnet/flow_diagram_depth.jpg" />
...
3. 在 `Load Image` 节点中点击 `Upload`，上传之前提供的 Depth 图像
4. 点击 `Queue` 按钮，或者使用快捷键 `Ctrl(cmd) + Enter（回车）` 来执行图像生成
...
关于多个 ControlNet 混合使用，可以参考 [混合 ControlNet](https://docs.comfy.org/zh/tutorials/controlnet/mixing-controlnets) 示例。
