...
<img src="/img/tutorial/video/wan/wan2_2/template.jpg" alt="Wan2.2 template" width="3450" height="1944" data-path="images/tutorial/video/wan/wan2_2/template.jpg" />
...
<h3 id="video_wan2_2_5B_ti2v">
  Wan 2.2 5B 视频生成
</h3>

以 5B 参数实现快速的文生视频与图生视频生成。专为快速原型制作和创意探索而优化。

<img src="/img/external/raw-githubusercontent-com/templates/video_wan2_2_5B_ti2v-1.webp" alt="Wan 2.2 5B 视频生成工作流预览" />
...
所有提及的模型均可在 [Comfy-Org/Wan\_2.2\_ComfyUI\_Repackaged](https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged) 中找到。
...
<CardGroup cols={1}>
  <Card title="wan2.2_ti2v_5B_fp16.safetensors" icon="download" href="https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/blob/main/split_files/diffusion_models/wan2.2_ti2v_5B_fp16.safetensors">
    5B 混合 diffusion 模型。放置于 <code>ComfyUI/models/diffusion\_models/</code>
  </Card>
</CardGroup>
...
<CardGroup cols={1}>
  <Card title="wan2.2_vae.safetensors" icon="download" href="https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/blob/main/split_files/vae/wan2.2_vae.safetensors">
    Wan2.2 VAE。放置于 <code>ComfyUI/models/vae/</code>
  </Card>
</CardGroup>
...
<CardGroup cols={1}>
  <Card title="umt5_xxl_fp8_e4m3fn_scaled.safetensors" icon="download" href="https://huggingface.co/Comfy-Org/Wan_2.1_ComfyUI_repackaged/blob/main/split_files/text_encoders/umt5_xxl_fp8_e4m3fn_scaled.safetensors">
    FP8 文本编码器。放置于 <code>ComfyUI/models/text\_encoders/</code>
  </Card>
</CardGroup>
...
<img src="/img/tutorial/video/wan/wan2_2/wan_2.2_5b_t2v.jpg" alt="步骤图" width="4182" height="2027" data-path="images/tutorial/video/wan/wan2_2/wan_2.2_5b_t2v.jpg" />
...
<h3 id="video_wan2_2_14B_t2v">
  Wan 2.2 14B 文生视频
</h3>

使用 Wan 2.2 从文本提示生成高质量视频，具备电影级美学控制与动态运动生成能力。

<img src="/img/external/raw-githubusercontent-com/templates/video_wan2_2_14B_t2v-1.webp" alt="Wan 2.2 14B 文生视频工作流预览" />
...
上述所有模型都可以在 [Comfy-Org/Wan\_2.2\_ComfyUI\_Repackaged](https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged) 中找到。
...
<CardGroup cols={2}>
  <Card title="wan2.2_t2v_high_noise_14B_fp8_scaled.safetensors" icon="download" href="https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/blob/main/split_files/diffusion_models/wan2.2_t2v_high_noise_14B_fp8_scaled.safetensors">
    高噪波 Diffusion 模型。放置到 <code>ComfyUI/models/diffusion\_models/</code>
  </Card>
  ...
  <Card title="wan2.2_t2v_low_noise_14B_fp8_scaled.safetensors" icon="download" href="https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/blob/main/split_files/diffusion_models/wan2.2_t2v_low_noise_14B_fp8_scaled.safetensors">
    低噪波 Diffusion 模型。放置到 <code>ComfyUI/models/diffusion\_models/</code>
  </Card>
</CardGroup>
...
<CardGroup cols={1}>
  <Card title="wan_2.1_vae.safetensors" icon="download" href="https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/blob/main/split_files/vae/wan_2.1_vae.safetensors">
    Wan2.1 VAE（与 Wan2.2 兼容）。放置到 <code>ComfyUI/models/vae/</code>
  </Card>
</CardGroup>
...
<CardGroup cols={1}>
  <Card title="umt5_xxl_fp8_e4m3fn_scaled.safetensors" icon="download" href="https://huggingface.co/Comfy-Org/Wan_2.1_ComfyUI_repackaged/blob/main/split_files/text_encoders/umt5_xxl_fp8_e4m3fn_scaled.safetensors">
    FP8 文本编码器。放置到 <code>ComfyUI/models/text\_encoders/</code>
  </Card>
</CardGroup>
...
<img src="/img/tutorial/video/wan/wan2_2/wan_2.2_14b_t2v.jpg" alt="步骤示意图" width="4182" height="2255" data-path="images/tutorial/video/wan/wan2_2/wan_2.2_14b_t2v.jpg" />
...
<video controls className="w-full aspect-video" src="/img/external/raw-githubusercontent-com/2.2/wan_2_2_14B_i2v.mp4" />
...
你可以使用下面的图片作为输入
![输入图片](/img/external/raw-githubusercontent-com/2.2/input.jpg)
...
<img src="/img/tutorial/video/wan/wan2_2/wan_2.2_14b_i2v.jpg" alt="步骤图" width="4182" height="2336" data-path="images/tutorial/video/wan/wan2_2/wan_2.2_14b_i2v.jpg" />
...
<h3 id="video_wan2_2_14B_flf2v">
  Wan 2.2 14B 首尾帧转视频
</h3>

通过定义起始帧和结束帧，生成平滑的视频过渡。

<img src="/img/external/raw-githubusercontent-com/templates/video_wan2_2_14B_flf2v-1.webp" alt="Wan 2.2 14B 首尾帧转视频工作流预览" />

<CardGroup cols={2}>
  <Card title="在 Comfy Cloud 上运行" icon="cloud" href="https://cloud.comfy.org/?template=video_wan2_2_14B_flf2v&utm_source=docs&utm_medium=referral&utm_campaign=wan2_2">
    在 Comfy Cloud 中打开
  </Card>
...
<CardGroup cols={2}>
  <Card title="video_wan2_2_14B_flf2v_start_image.png" icon="image" href="/img/external/raw-githubusercontent-com/input/video_wan2_2_14B_flf2v_start_image.png">
    `LoadImage` 节点 62 · `video_wan2_2_14B_flf2v_start_image.png`
  </Card>

  <Card title="video_wan2_2_14B_flf2v_end_image.png" icon="image" href="/img/external/raw-githubusercontent-com/input/video_wan2_2_14B_flf2v_end_image.png">
    `LoadImage` 节点 68 · `video_wan2_2_14B_flf2v_end_image.png`
  </Card>
</CardGroup>

<div style={{display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '1rem', alignItems: 'start'}}>
  <img src="/img/external/raw-githubusercontent-com/input/video_wan2_2_14B_flf2v_start_image.png" alt="video_wan2_2_14B_flf2v_start_image.png" style={{width: '100%', height: 'auto', objectFit: 'contain'}} />

  <img src="/img/external/raw-githubusercontent-com/input/video_wan2_2_14B_flf2v_end_image.png" alt="video_wan2_2_14B_flf2v_end_image.png" style={{width: '100%', height: 'auto', objectFit: 'contain'}} />
</div>

### 2. 按步骤操作

<img src="/img/tutorial/video/wan/wan2_2/wan_2.2_14b_flf2v.jpg" alt="步骤图" width="2091" height="1540" data-path="images/tutorial/video/wan/wan2_2/wan_2.2_14b_flf2v.jpg" />
