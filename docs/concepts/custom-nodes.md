...
> ComfyUI 自定义节点：与 Comfy Core 节点的区别，以及安装、更新、启用依赖、禁用和卸载方法。
...
<Card title="开始开发自定义节点" icon="link" href="https://docs.comfy.org/zh/custom-nodes/overview">
  了解如何开始开发一个自定义节点
</Card>
...
但由于目前所有的自定义节点都是存储在 GitHub 上，所以在本篇针对于某些无法正常访问 GitHub 的地区，我们在本篇撰写了详尽的不同的自定义节点的安装方式。
  ...
  <TabItem value="通过 Git 安装">
    <Steps>
      <Step title="确保 Git 已经安装">
        ...
        <img src="/img/concepts/custom_nodes/win_terminal.jpg" alt="Windows 终端" width="1114" height="228" data-path="images/concepts/custom_nodes/win_terminal.jpg" />
        ...
        <Tip>
          对于 Comfy Desktop 版本,你可以参考下面的方式使用 Desktop 的终端来完成对应的安装。

          <img src="/img/concepts/custom_nodes/desktop_terminal.png" alt="Comfy Desktop 终端" width="1804" height="1474" data-path="images/concepts/custom_nodes/desktop_terminal.png" />
        </Tip>
      </Step>
      ...
      <Step title="克隆自定义节点代码到对应目录">
        ...
        <img src="/img/concepts/custom_nodes/install_custom_nodes_by_git.jpg" alt="通过 Git 安装自定义节点" width="1116" height="317" data-path="images/concepts/custom_nodes/install_custom_nodes_by_git.jpg" />

        这意味着你已经成功克隆了对应的自定义节点的代码，接下来我们需要进行对应依赖的安装。
      </Step>

      <Step title="安装依赖">
        请参考[安装节点依赖](#2-安装节点依赖)章节中的说明进行对应的依赖安装。
      </Step>
    </Steps>
  </TabItem>
  ...
  <TabItem value="手动安装">
    ...
    <Steps>
      <Step title="下载自定义节点代码 zip 包">
        ...
        <img src="/img/concepts/custom_nodes/download_zip.jpg" alt="下载节点代码" width="1011" height="618" data-path="images/concepts/custom_nodes/download_zip.jpg" />
...
<Tabs>
  <TabItem value="ComfyUI 便携版（Portable）">
    ...
    <img src="/img/concepts/custom_nodes/open_terminal.jpg" alt="启动 terminal" width="1822" height="1187" data-path="images/concepts/custom_nodes/open_terminal.jpg" />

    确保对应终端的目录为 `\ComfyUI_windows_portable\` 目录下，如下图为 `D:\ComfyUI_windows_portable\`

    <img src="/img/concepts/custom_nodes/terminal.jpg" alt="终端" width="2400" height="1147" data-path="images/concepts/custom_nodes/terminal.jpg" />
  ...
  <TabItem value="Comfy 桌面版">
    <Tip>
      由于 Comfy 桌面版在安装过程中已经安装了 ComfyUI-Manager 及对应依赖，但本文是以 ComfyUI Manager 作为自定义节点安装为示例讲解的，实际上你并不需要再在桌面版中执行 ComfyUI Manager 的依赖安装。
    ...
    <img src="/img/concepts/custom_nodes/install_dependencies.png" alt="Comfy Desktop 依赖安装" width="1800" height="1474" data-path="images/concepts/custom_nodes/install_dependencies.png" />
  </TabItem>

  <TabItem value="自定义 Python 环境的用户">
...
<Tabs>
  <TabItem value="使用 ComfyUI Manager 进行版本管理">
...
安装 Git 后，导航到 ComfyUI 服务器程序目录，进入标记为 **custom\_nodes** 的文件夹。打开命令窗口或终端。确保命令行显示当前目录路径为 **custom\_nodes**。然后运行以下命令来克隆 ComfyUI-Manager 仓库：

```bash theme={null}
git clone https://github.com/Comfy-Org/ComfyUI-Manager.git
```

这将下载管理器。从技术上讲，这被称为 *克隆 Git 仓库*。
